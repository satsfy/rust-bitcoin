...
mod tests {
    ...
    #[test]
    #[cfg(feature = "compat")]
    fn sequence_compat_round_trip() {
        let sequences = [
            Sequence::ZERO,
            Sequence::from_consensus(0xFFFF_FFFE), // Disables locktime, enables RBF.
            Sequence::MAX,
        ];
        for sequence in sequences {
            assert_eq!(Sequence::from_stable(sequence.to_stable()), sequence);
        }
    }
